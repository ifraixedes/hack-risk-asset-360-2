...
gulp.task('fonts-vendor', function () {
  ...
  .pipe(gulpPlugins.size({ title: 'fonts-vendor' }));
});
...
gulp.task('dev', ['styles', 'scripts', 'views', 'html', 'fonts', 'fonts-vendor', 'images', 'vendor-scripts', 'vendor-styles'], function () {
  browserSync({
    notify: false,
...
gulp.task('build', ['clean'], function (cb) {
  runSequence(['scripts', 'styles', 'images', 'fonts', 'fonts-vendor', 'vendor-styles', 'vendor-scripts'], function (error) {
    if (error) {
      cb(error);
    } else {
